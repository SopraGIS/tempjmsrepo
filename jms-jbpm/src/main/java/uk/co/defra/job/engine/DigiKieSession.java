...
//	@Inject
//	private RewardsApplicationScopedProducer rewardsApplicationScopedProducer;
	 ...
	 * this is retrieved from the KieSession by invoking a command object
	...
	public Map<String, Object> viewVariables(final Long processId) {
		...
		// String processId =
		// rewardsApplicationScopedProducer.getJBPMRuntimeManager().getRuntimeEngine(null).getTaskService().get

		// ksession =
		// rewardsApplicationScopedProducer.getJBPMRuntimeManager().getRuntimeEngine(null).getKieSession();
